...
engine = create_engine('postgresql://admin:admin@localhost/itemcatalog.db')
...
def editedCategory(category_id):
    ...
    if editedCategory.user_id != login_session['user_id']:
        ...
        category in order to edit.');}</script><body onload='myFunction()''>"
    if request.method == 'POST':
...
def deleteCategory(category_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('delete_category.html', category=categoryToDel)
